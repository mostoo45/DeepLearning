...
def yolo_filter_boxes(box_confidence, boxes, box_class_probs, threshold = .6):
    ...
    #box_scores = tf.reshape(box_confidence,[19*19,5,1])*tf.reshape(box_class_probs,[19*19,5,80])
    ...
    #print(scores.shape)
    #boxes =tf.boolean_mask(tf.reshape(boxes,[19*19,5,4]),filtering_mask ,name='boolean_mask')
    boxes =tf.boolean_mask(boxes,filtering_mask ,name='boolean_mask')
    #print(boxes.shape[0]*boxes.shape[1],boxes.shape[2],boxes.shape[3])
