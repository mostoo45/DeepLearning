        ...
        for h in range(n_H):                     # loop on the vertical axis of the output volume
            for w in range(n_W):                 # loop on the horizontal axis of the output volume
                for c in range (n_C):            # loop over the channels of the output volume
                    ...
                    #a_prev_slice = np.zeros((vert_end-vert_start, horiz_end-horiz_start)) #data[vert_start:vert_end][horiz_start:horiz_end][c]
                    a_prev_slice=data[vert_start:vert_end,horiz_start:horiz_end,c]
                    #for k in range(vert_start,vert_end):
                    #    for j in range(horiz_start,horiz_end):
                    #        a_prev_slice[k][j]=data[k][j][c] 
